...
%prep
%setup -q -n WALinuxAgent-2.3.1.1
cd %{_builddir}/WALinuxAgent-2.3.1.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629505998
...
cp %{_builddir}/WALinuxAgent-2.3.1.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/WALinuxAgent/861181924d993ee58a17a2c3c3a3faecf895849c
