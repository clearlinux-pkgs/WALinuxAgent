...
Version  : 2.2.47.1
Release  : 76
URL      : https://github.com/Azure/WALinuxAgent/archive/v2.2.47.1/WALinuxAgent-2.2.47.1.tar.gz
Source0  : https://github.com/Azure/WALinuxAgent/archive/v2.2.47.1/WALinuxAgent-2.2.47.1.tar.gz
...
%prep
%setup -q -n WALinuxAgent-2.2.47.1
cd %{_builddir}/WALinuxAgent-2.2.47.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585086955
...
cp %{_builddir}/WALinuxAgent-2.2.47.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/WALinuxAgent/861181924d993ee58a17a2c3c3a3faecf895849c
