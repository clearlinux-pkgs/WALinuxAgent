...
Source0  : https://github.com/Azure/WALinuxAgent/archive/v2.3.0.2/WALinuxAgent-2.3.0.2.tar.gz
...
%prep
%setup -q -n WALinuxAgent-2.3.0.2
cd %{_builddir}/WALinuxAgent-2.3.0.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624307973
...
cp %{_builddir}/WALinuxAgent-2.3.0.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/WALinuxAgent/861181924d993ee58a17a2c3c3a3faecf895849c
