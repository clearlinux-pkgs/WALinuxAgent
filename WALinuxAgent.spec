...
Version  : 2.2.26
Release  : 64
URL      : https://github.com/Azure/WALinuxAgent/archive/v2.2.26.tar.gz
Source0  : https://github.com/Azure/WALinuxAgent/archive/v2.2.26.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1536264923
