...
Version  : 2.2.2
Release  : 29
URL      : https://github.com/Azure/WALinuxAgent/archive/v2.2.2.tar.gz
Source0  : https://github.com/Azure/WALinuxAgent/archive/v2.2.2.tar.gz
...
%prep
%setup -q -n WALinuxAgent-2.2.2

%build
export LANG=C
export SOURCE_DATE_EPOCH=1485200729
