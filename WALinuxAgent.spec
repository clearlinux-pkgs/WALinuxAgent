...
Version  : 2.11.1.4
Release  : 103
URL      : https://github.com/Azure/WALinuxAgent/archive/v2.11.1.4/WALinuxAgent-2.11.1.4.tar.gz
Source0  : https://github.com/Azure/WALinuxAgent/archive/v2.11.1.4/WALinuxAgent-2.11.1.4.tar.gz
...
%prep
%setup -q -n WALinuxAgent-2.11.1.4
cd %{_builddir}/WALinuxAgent-2.11.1.4
%patch -P 1 -p1
pushd ..
cp -a WALinuxAgent-2.11.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719950512
