...
Version  : 2.2.6
Release  : 32
URL      : https://github.com/Azure/WALinuxAgent/archive/v2.2.6.tar.gz
Source0  : https://github.com/Azure/WALinuxAgent/archive/v2.2.6.tar.gz
...
%prep
%setup -q -n WALinuxAgent-2.2.6

%build
export LANG=C
export SOURCE_DATE_EPOCH=1489128792
