...
%prep
%setup -q -n WALinuxAgent-2.2.46
cd %{_builddir}/WALinuxAgent-2.2.46
%patch1 -p1
...
cp %{_builddir}/WALinuxAgent-2.2.46/LICENSE.txt %{buildroot}/usr/share/package-licenses/WALinuxAgent/861181924d993ee58a17a2c3c3a3faecf895849c
