...
Version  : 2.2.49.1
Release  : 79
URL      : https://github.com/Azure/WALinuxAgent/archive/v2.2.49.1/WALinuxAgent-2.2.49.1.tar.gz
Source0  : https://github.com/Azure/WALinuxAgent/archive/v2.2.49.1/WALinuxAgent-2.2.49.1.tar.gz
...
%prep
%setup -q -n WALinuxAgent-2.2.49.1
cd %{_builddir}/WALinuxAgent-2.2.49.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593712305
...
cp %{_builddir}/WALinuxAgent-2.2.49.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/WALinuxAgent/861181924d993ee58a17a2c3c3a3faecf895849c
